...
//			System.out.println(c.toString());
	...
	private JLabel getLblLogo() {
		if (lblLogo == null) {
			...
			lblLogo.setBounds(103, 21, 409, 38);
		}
		return lblLogo;
	}
	...
	private JPanel getPanelProductosSeleccionados() {
		if (panelProductosSeleccionados == null) {
			...
			panelProductosSeleccionados.setBounds(598, 84, 222, 454);
	...
	private JScrollPane getScrollPaneCarrito() {
		if (scrollPaneCarrito == null) {
			...
			scrollPaneCarrito.setBounds(10, 42, 202, 225);
	...
	private JButton getBtnVaciar() {
		if (btnVaciar == null) {
			...
			btnVaciar.setEnabled(false);
			btnVaciar.setBounds(20, 386, 192, 23);
		}
		return btnVaciar;
	}
	...
	private JButton getBtnModificar() {
		if (btnModificar == null) {
			...
			btnModificar.setEnabled(false);
			btnModificar.setBounds(20, 352, 192, 23);
		}
		return btnModificar;
	}
	...
	private JButton getButtonEliminar() {
		if (buttonEliminar == null) {
			...
			buttonEliminar.setEnabled(false);
			buttonEliminar.setBounds(20, 318, 192, 23);
		}
	...
	private JButton getBtnProcederConLa() {
		if (btnProcederConLa == null) {
			...
			btnProcederConLa.setEnabled(false);
			btnProcederConLa.setBounds(20, 420, 192, 23);
	...
	private JLabel getLblPrecioTotal() {
		if (lblPrecioTotal == null) {
			...
			lblPrecioTotal.setBounds(20, 278, 96, 35);
		}
	...
	private JTextField getTextFieldPrecioTotal() {
		if (textFieldPrecioTotal == null) {
			...
			textFieldPrecioTotal.setBounds(126, 287, 86, 20);
	...
	private JLabel getLblCarrito() {
		if (lblCarrito == null) {
			...
			lblCarrito.setBounds(10, 11, 202, 20);
		}
		return lblCarrito;
	}
